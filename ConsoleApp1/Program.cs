...
Locatie loc1 = new Locatie("Hoboken", "Meetjeslandstraat", "Antwerpen", 2660, "25E");
Locatie loc2 = new Locatie("station", "Eedverbondkaai", "Gent", 9000, "7");
Locatie loc3 = new Locatie("rabot", "Prinses Clementinalaan", "Gent", 9000, "277");
