...
InnovatieWonen innov2 = new InnovatieWonen("NogEensProberen", new DateTime(2000, 1, 1), "Testestetstt", ProjectbeheerBL.Domein.Enums.ProjectStatus.Planning, loc, 22, true, true, 10.0, true);
repo.VoegProjectToe(innov2);